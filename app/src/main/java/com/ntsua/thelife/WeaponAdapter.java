...
public class WeaponAdapter extends BaseAdapter {
    ...
    Context context;
    int layout;
    ArrayList<product> arrprocrime;

    public WeaponAdapter(Context context,int layout, ArrayList<product> arrprocrime)
    {
        this.context = context;
        this.layout = layout;
        this.arrprocrime = arrprocrime;
    }

    @Override
    public int getCount() {
        return arrprocrime.size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            product crime = arrprocrime.get(position);
            viewholder.imgCrime.setImageResource(crime.getImage());
            viewholder.txtCrimename.setText(crime.getProname());
